...
MACRO (ROOT_GENERATE_DICTIONARY _NAME)
  ...
  SET (_INCLUDE_DIRS)
  get_property (_DIR_INCLUDE_DIRS DIRECTORY PROPERTY INCLUDE_DIRECTORIES)
  ...
  FOREACH (_current_FILE ${${_NAME}_INCLUDE_DIRS} ${_DIR_INCLUDES} ${_DIR_INCLUDE_DIRS})
  ...
  IF (${_NAME}_VERBOSE)
    ...
    MESSAGE ("   FLAGS   : ${${_NAME}_DEFINE_FLAGS}")
  ENDIF (${_NAME}_VERBOSE)

  ADD_CUSTOM_COMMAND (OUTPUT ${${_NAME}_DICT_SOURCE} ${${_NAME}_DICT_HEADER}
    COMMAND ${ROOTCINT} -f ${${_NAME}_DICT_SOURCE} -c -p ${_INCLUDE_DIRS} ${_DEFINE_FLAGS} ${${_NAME}_INFILES} ${${_NAME}_LINKDEF}
